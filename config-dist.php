...
$CFG->dbhost    = getenv('MARIADB_HOST') ?: 'mariadb';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = getenv('MARIADB_DATABASE') ?: 'lagoon';     // database name, eg moodle
$CFG->dbuser    = getenv('MARIADB_USERNAME') ?: 'lagoon';   // your database username
$CFG->dbpass    = getenv('MARIADB_PASSWORD') ?: 'lagoon';   // your database password
...
$CFG->wwwroot   = getenv('LAGOON_ROUTE');
